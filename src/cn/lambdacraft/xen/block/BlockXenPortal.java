...
public class BlockXenPortal extends BlockContainer {
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null && par5Entity instanceof EntityPlayerMP)
        {
            ...
            else if (thePlayer.dimension != ModuleXen.dimensionId)
            {
                    thePlayer.timeUntilPortal = 10;
                    thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, ModuleXen.dimensionId, new TeleporterXen(thePlayer.mcServer.worldServerForDimension(ModuleXen.dimensionId)));
            }
            else {
                    thePlayer.timeUntilPortal = 10;
