package cn.lambdacraft.xen.world.chunk;
...
import cn.lambdacraft.xen.world.gen.layer.GenLayerXen;
 ...
 *
 */
public class WorldChunkManagerXen extends WorldChunkManager {
    ...
    protected WorldChunkManagerXen()
    {
    ...
    public WorldChunkManagerXen(long par1, WorldType par3WorldType)
    {
        this();
        GenLayer[] agenlayer = GenLayerXen.makeTheWorld(par1);
        agenlayer = getModdedBiomeGenerators(par3WorldType, par1, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public WorldChunkManagerXen(World par1World)
    {
