        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == XENBlocks.portal.blockID)
                        {
                            while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == XENBlocks.portal.blockID)
                            {
                                --i2;
                            }
        ...
        for (k2 = -1; k2 < 2; ++k2)
        {
            for (i3 = -1; i3 < 2; ++i3)
            {
                for (l2 = -1; l2 < 2; ++l2)
                {
                    ...
                    i4 = j2 + i3;
                    flag = l2 == 0 && k2 == 0 && i3 == 0;
                    this.worldServerInstance.setBlock(k3, j3, i4, l2 == -1 ? XENBlocks.desertedDirt.blockID : flag ? XENBlocks.portal.blockID : 0, 0, 2);
